...
// Preserve the 128×128 coordinate system used by these custom icon paths.
const createLargeIcon = (path: string) => ({ path, viewBox: "0 0 128 128" });
